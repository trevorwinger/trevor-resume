    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className="Body">
          ...
          <Section header='Work Experience' bodyText={['Product Manager - Software : Art Unlimited (current)', 
          'Software Engineer : L&M Radiator (1 year)', 
          'Technology Assistant : University of Minnesota Duluth (2 years)']} />
